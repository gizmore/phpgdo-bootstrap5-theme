...
<div class="gdt-panel gdt-accordeon accordion">
    <div class="accordion-item">
        <h2 class="accordion-header">
            <button class="accordion-button<?=$field->opened ? '' : ' collapsed'?>" type="button" data-bs-toggle="collapse" data-bs-target="#<?=$field->name?>"
                    aria-expanded="<?=$field->opened ? 'true' : 'false'?>">
				<?=$field->renderTitle()?>
            </button>
        </h2>
